...
$modulosDisponibles = [
    ...
    ['id' => 'compras', 'label' => 'Compras (consultar)', 'grupo' => 'Compras'],
    ['id' => 'compras_editar', 'label' => 'Crear/Editar compras', 'grupo' => 'Compras'],
    ['id' => 'financiaciones', 'label' => 'Financiaciones (consultar)', 'grupo' => 'Financiaciones'],
    ['id' => 'financiaciones_editar', 'label' => 'Crear/Editar financiaciones', 'grupo' => 'Financiaciones'],
    ['id' => 'financiaciones_pagar', 'label' => 'Registrar pagos de cuotas', 'grupo' => 'Financiaciones'],
